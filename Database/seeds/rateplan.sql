-- User 1
INSERT INTO users (id, name, address, birthdate)
VALUES (1, 'Ahmed Mohamed', 'Cairo, Egypt', '1990-05-15');
...
-- User 2
INSERT INTO users (id, name, address, birthdate)
VALUES (2, 'Mohamed Ali', 'Alexandria, Egypt', '1988-09-20');
...
-- User 3
INSERT INTO users (id, name, address, birthdate)
VALUES (3, 'Sara Hassan', 'Giza, Egypt', '1995-03-10');
...
-- User 4
INSERT INTO users (id, name, address, birthdate)
VALUES (4, 'Omar Khaled', 'Mansoura, Egypt', '1992-12-05');
