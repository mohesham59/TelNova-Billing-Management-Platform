...
public class ContractServlet extends HttpServlet {
            ...
            for (Contract ct : contracts) {
                ...
                out.printf("""
                    <tr>
                      ...
                      <td>%s</td>
                      <td>%s</td>
                      <td style='color:var(--accent2);font-weight:600;'>$%s</td>
    ...
    private void renderForm(HttpServletRequest req, HttpServletResponse resp, Contract ct, boolean editing)
        ...
        // Customer dropdown
        out.print("<div class='form-group'><label>Customer *</label><select name='userId' required>");
        out.print("<option value=''>-- Select Customer --</option>");
        for (User u : users) {
        ...
        // Rate plan dropdown
        out.print("<div class='form-group'><label>Rate Plan *</label><select name='ratePlanId' required>");
        out.print("<option value=''>-- Select Rate Plan --</option>");
        ...
        // Status dropdown
        String[] statuses = {"active", "suspended", "de-active", "on-hold"};
        ...
        for (String s : statuses) {
            ...
            out.printf("<option value='%s'%s>%s</option>", s, sel, capitalize(s));
        }
        out.print("</select></div>");
        ...
        out.printf("""
                    <div class='form-group'>
                      ...
                      <input type='text' name='msisdn' value='%s' placeholder='e.g. +201012345678' required maxlength='20'>
                    </div>
                    <div class='form-group'>
