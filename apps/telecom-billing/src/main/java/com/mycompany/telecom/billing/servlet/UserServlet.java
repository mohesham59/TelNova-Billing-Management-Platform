...
public class UserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            else if (path.equals("/new"))                 renderForm(req, resp, new User(), false);
            else if (path.startsWith("/edit/")) {
                User u = dao.findById(path.substring(6));
    ...
    private void renderList(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        if (users.isEmpty()) {
            ...
            out.print("""
                <table><thead><tr>
                  <th>ID</th><th>Name</th><th>Email</th><th>Birthdate</th><th>Address</th><th>Actions</th>
                </tr></thead><tbody>
                """);
            for (User u : users) {
                out.printf("""
                    <tr>
                      ...
                      <td style='color:var(--muted);'>%s</td>
                      <td style='color:var(--muted);max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;'>%s</td>
                    ...
                    """,
                        ...
                        HtmlLayout.e(u.getEmail()), HtmlLayout.e(u.getBirthdate()),
    ...
    private void renderForm(HttpServletRequest req, HttpServletResponse resp,
        ...
        out.printf("""
                ...
                <form method='post' action='%s'>
                  <div class='form-grid'>
                    ...
                    <div class='form-group'>
                      ...
                      <input type='email' name='email' value='%s' placeholder='customer@example.com' required>
                    </div>
                    <div class='form-group'>
                      <label>Portal Password %s</label>
            ...
            """,
                ...
                editing ? "New password or leave blank" : "Set portal password",
                editing ? "" : "required",
