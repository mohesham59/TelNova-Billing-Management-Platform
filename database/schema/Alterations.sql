...
ALTER TABLE bill ADD COLUMN IF NOT EXISTS usage_cost NUMERIC(12,2) NOT NULL DEFAULT 0;

ALTER TABLE cdr DROP COLUMN IF EXISTS hplmn;
ALTER TABLE cdr DROP COLUMN IF EXISTS vplmn;

ALTER TABLE cdr ADD COLUMN IF NOT EXISTS rated_cost NUMERIC(12,2) NOT NULL DEFAULT 0;
