 ...
 */
/**
 * A read-only view of contract_consumption joined with service_package.
 * Used exclusively for the customer portal display.
 */
public class ConsumptionView {
    ...
    public int getPercentage() {
        if (totalQuota == null || totalQuota.compareTo(BigDecimal.ZERO) == 0) return 0;
    ...
    public BigDecimal getRemaining() {
        if (totalQuota == null) return BigDecimal.ZERO;
        if (consumed == null)   return totalQuota;
